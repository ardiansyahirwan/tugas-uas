               ...
               <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                     ...
                     <div class="h5 mb-0 font-weight-bold text-gray-800">
                        <?=
                           $this->User_model->getUserWhere(['role_id' => 2])->num_rows();
                        ?>
                     </div>
                  </div>
                  <div class="col-auto">
      ...
      <div class="col-xl-3 col-md-6 mb-4">
         <div class="card border-left-success shadow h-100 py-2">
            <div class="card-body">
               <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                     <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Jumlah SKS</div>
                     <div class="h5 mb-0 font-weight-bold text-gray-800">
                        <?php
                        $where = ['sks!= 0'];
                        $total_sks = $this->Jadwal_model->total('sks', $where);
                        echo $total_sks;
                        ?>
                     </div>
                  </div>
                  ...
                  <div class="col mr-2">
                     ...
                     <div class="row no-gutters align-items-center">
                        <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                           <?=
                              $this->Jadwal_model->getMatkul()->num_rows();
                           ?>
                        </div>
                     </div>
                  </div>
